...
public class ExpressionImpl implements Expression {
    ...
    */		
	public BaseExpr getExpression()
	{
		...
		if (element.getNodeName().equals(FilterConst.Function)) {
			bex = new FunctionImpl();
		}
	   else
	    if (element.getNodeName().equals(FilterConst.PropertyName)) {
			bex = new PropertyNameImpl();
		}
	   else		
	    if (element.getNodeName().equals(FilterConst.Literal)) {
			bex = new LiteralImpl();
		}	
	   else		
	    if (element.getNodeName().equals(FilterConst.Add)) {
			bex = new AddImpl();
		}	
	   else		
	    if (element.getNodeName().equals(FilterConst.Sub)) {
			bex = new SubImpl();
		}	
	   else		
	    if (element.getNodeName().equals(FilterConst.Mul)) {
			bex = new MulImpl();
		}	
	   else		
	    if (element.getNodeName().equals(FilterConst.Div)) {
			bex = new DivImpl();
		}	
