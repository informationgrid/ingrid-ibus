    ...
    */	
	public CompOperation getCompOperation() throws CSWFilterException
	{
		...
		try {
			...
			if ( element.getNodeName().equals( FilterConst.PropertyIsBetween ) ) {
				comp = new PropertyIsBetweenImpl();
			}
		   else	
		    if ( element.getNodeName().equals( FilterConst.PropertyIsEqualTo) ) {
				comp = new PropertyIsEqualToImpl();
			}
		   else	
		    if ( element.getNodeName().equals( FilterConst.PropertyIsGreaterThan) ) {
				comp = new PropertyIsGreaterThanImpl();
			}
		   else	
		    if ( element.getNodeName().equals( FilterConst.PropertyIsGreaterThanOrEqualTo) ) {
				comp = new PropertyIsGreaterThanOrEqualToImpl();
			}
		   else	
		    if ( element.getNodeName().equals( FilterConst.PropertyIsLessThan) ) {
				comp = new PropertyIsLessThanImpl();
			}
		   else	
		    if ( element.getNodeName().equals( FilterConst.PropertyIsLessThanOrEqualTo) ) {
				comp = new PropertyIsLessThanOrEqualToImpl();
			}
		   else	
		    if ( element.getNodeName().equals( FilterConst.PropertyIsLike) ) {
				comp = new PropertyIsLikeImpl();
			}
		   else	
		    if ( element.getNodeName().equals( FilterConst.PropertyIsNull) ) {
